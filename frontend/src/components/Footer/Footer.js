          ...
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <div className="flex mt-4 -mx-2">
                <a href="https://github.com/JackyTea/Mock-Stocks" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="GitHub">
