        ...
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <p className="max-w-md mt-2 text-gray-500 dark:text-gray-400">The investment platform for all.</p>

              <div className="flex mt-4 -mx-2">
                <a href="https://github.com/JackyTea" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="GitHub">
                ...
                <a href="https://jackytea.com/" className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Personal Website">
                  <svg className="text-gray-800 dark:text-white h-4 w-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
              ...
              <div>
                ...
                <a href="https://socket.io/" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Socket.IO</a>
              </div>
              ...
              <div>
                ...
                <a href="https://github.com/JackyTea" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">GitHub</a>
                <a href="https://jackytea.com/" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Personal Site</a>
              </div>
            </div>
          </div>
        </div>
