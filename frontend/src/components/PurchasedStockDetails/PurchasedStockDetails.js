				...
				<div className="container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-128 lg:py-16 lg:flex-row lg:items-center lg:space-x-6">
					<div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
						<div className="max-w-lg lg:mx-12 lg:order-2">
							...
							{
								state &&
								<div onClick={() => {window.history.replaceState({}, document.title); window.location.reload();}} class="cursor-pointer mt-6 flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
									...
									<div class="px-4 py-2 -mx-3">
										<div class="mx-3">
											...
											<p class="text-xs text-gray-600 dark:text-gray-200">Looks like you just bought / updated this investment. Your funds may not be updated away. Click here to refresh the funding amount in the top bar.</p>
										</div>
									</div>
								</div>
							}
